...
public class dataBaseHandler {
    ...
    private final String DB_USER = "s289786";
    private final String DB_PASS = "hzg570"; //put it in Ur mouth
    ...
    public void makeSSH(){
        try{
            ...
            final String user="s289786";
            final String password="hzg570"; //put it in Ur mouth
